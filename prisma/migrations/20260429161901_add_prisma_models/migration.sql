/*
  ...
  - You are about to drop the column `email` on the `Membre` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "Membre" DROP COLUMN "email";
...
-- CreateIndex
CREATE UNIQUE INDEX "user_email_membreId_key" ON "user"("email", "membreId");
