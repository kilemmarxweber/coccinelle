...
import { HotelSignUpForm } from "@/components/hotel/hotel-sign-up-form";
...
export const metadata: Metadata = {
  ...
  description: "Créez un compte pour l’espace client hôtel.",
};
...
export default async function HotelInscriptionPage({
  params,
  searchParams,
}: PageProps) {
