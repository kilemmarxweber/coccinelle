...
import { getFinanceReportAction } from "@/lib/hotel/reports/actions";
import { defaultReportRange } from "@/lib/hotel/reports/period";
import { FinanceReportClient } from "../_components/report-clients";
...
export default async function RapportFinancierPage({
  ...
  const data = await getFinanceReportAction({
    organizationId,
    branchId,
    from,
    to,
